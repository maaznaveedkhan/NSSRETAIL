...
<div class="content-page">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="tab-content" id="bootstrap_tabs">
                    @foreach ($bills as $item)
                                        ...
                                        <form>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <select id="myselect" name="item_id" class="form-control" id="item_id" required>
...
<script>
    $(document).ready(function() {
          $('#add').click(function(event) {
            ...
            if (business_id != '' && bill_id != '' &&  item_id != '' && rate != '' && quantity != '') {
              $('.successmsg').html('');
...
$(document).ready(function(){
    ...
    if(activeTab){
        $('#bootstrap_tabs a[href="' + activeTab + '"]').tab('show');
    }
});
</script> --}}
<script>
