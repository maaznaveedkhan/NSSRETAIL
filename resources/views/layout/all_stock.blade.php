				...
				{{-- @if(sizeof($in) != 0) --}}
				  <ul class="responsive-table">
				    <li class="table-header mb-2">
				      ...
				      <div class="col">In<br><small style="color:red">Rs </small></div>
    ...
    <!-- Close Modal For Customer Form -->
		...
		<div class="modal fade" id="in" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
		  <div class="modal-dialog modal-dialog-centered">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="staticBackdropLabel"><span style="color:red">Rice</h5>
		        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
		      </div>
					...
					<div style="width:100%">
						<div class="col-sm-12">
							...
							<div class="row">
								...
								<input type="hidden" name="party" id="customer_id" class="form-control" value="">
							</div>
							<div>
						</div>
					</div>
